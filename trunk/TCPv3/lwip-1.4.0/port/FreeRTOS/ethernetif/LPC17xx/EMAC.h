...
#ifndef __EMAC_H
#define __EMAC_H
			/* MAC: 1E:30:6C:A2:20:5E	*/
#define MYMAC_1         0x5E            /* our ethernet (MAC) address        */
#define MYMAC_2         0x20            /* (MUST be unique in LAN!)          */
#define MYMAC_3         0xA2
#define MYMAC_4         0x6C
#define MYMAC_5         0x30
#define MYMAC_6         0x1E
...
#define NUM_RX_FRAG         6           /* Num.of RX Fragments 4*1536= 6.0kB */ //było 4 <-------------------
#define NUM_TX_FRAG         4           /* Num.of TX Fragments 3*1536= 4.6kB */ //było 2<--------------------
