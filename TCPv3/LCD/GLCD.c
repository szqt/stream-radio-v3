...
///////////////////////////////////////////////////////
  ...
  {
  	    wr_reg(0x0000,0x0001);    delay(5);  //´ňżŞľ§Őń
    	...
    	wr_reg(0x0001,0x2b3F);    delay(5);        //Çý¶ŻĘäłöżŘÖĆ320*240  0x6B3F  293f	2b3f 6b3f
    	wr_reg(0x0002,0x0600);    delay(5);
    	wr_reg(0x0010,0x0000);    delay(5);
    	wr_reg(0x0011,0x6078);    delay(5);        //0x4030           //¶¨ŇĺĘýľÝ¸ńĘ˝  16Î»É«  şáĆÁ 0x6058	   6078
    	...
    	wr_reg(0x000F,0x0000);    delay(5);        //É¨ĂčżŞĘĽµŘÖ·
    	...
    	wr_reg(0x004f,0);        //ĐĐĘ×Ö·0
    	wr_reg(0x004e,0);        //ÁĐĘ×Ö·0
  }
}
